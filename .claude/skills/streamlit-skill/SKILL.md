...
Use this skill when user interfaces are needed, such as an interface to communicate with a chatbot or open a panel with text details, lists, links and/or images.
